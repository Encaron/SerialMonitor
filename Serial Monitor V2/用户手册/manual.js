...
const I18N = {
    ...
    'idx-hero-version-meta': { zh: '作者：<strong style="color:var(--accent)">冯毅力 (Encaron)</strong> &nbsp;·&nbsp; v2.6.6 &nbsp;·&nbsp; Windows 10+ x64 &nbsp;·&nbsp; .NET 8 &nbsp;·&nbsp; MIT 开源', en: 'Author: <strong style="color:var(--accent)">Encaron (Feng Yili)</strong> &nbsp;·&nbsp; v2.6.6 &nbsp;·&nbsp; Windows 10+ x64 &nbsp;·&nbsp; .NET 8 &nbsp;·&nbsp; MIT Open Source' },
    ...
    'm-proto-desc-sensor': { zh: '9 种卡片类型（含 v2.6.6 波形图），零配置自动建卡', en: '9 card types (incl. v2.6.6 waveform), zero-config auto card creation' },
    ...
    'm-sensor-card-waveform': { zh: '波形图', en: 'Waveform' },
    ...
    'm-sensor-sub-heading-8': { zh: '9 类卡片（含 v2.6.6 波形图）', en: '9 Card Types (incl. v2.6.6 Waveform)' },
