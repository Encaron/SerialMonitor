...
namespace 串口助手
{
    ...
    public static class LogicValueMaps
    {
        ...
        public static string DisplayColor(string k) => k switch
        {
        ...
        public static string DisplaySendMode(string k) => k switch
        {
        ...
        public static string DisplayJoyStyle(string k) => k switch
        {
            "gamepad" => "手柄风", "minimal" => "极简风", "classic" => "经典风",
            _ => k,
        };

        public static string DisplaySliderStyle(string k) => k switch
        {
